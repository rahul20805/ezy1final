        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            <div className="flex items-center gap-1.5 mb-1">
              <h1 className="font-bold text-2xl sm:text-4xl tracking-tight leading-none">Everything you need, one place.</h1>
            </div>
            <div className="flex items-center gap-1 mt-2 opacity-90 text-sm font-medium">
              <MapPin className="w-4 h-4" />
              <span>Delivering to <strong className="font-bold border-b border-dashed">Indiranagar, Bengaluru</strong></span>
            </div>
          </div>
        </div>
