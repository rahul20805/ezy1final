  ...
  return (
    <Layout>
      <div className="container py-8 max-w-5xl">
        <div className="mb-8">
          <Badge className="mb-2 bg-primary/10 text-primary border-primary/20">Home Services</Badge>
          <h1 className="text-3xl font-display font-bold mb-4">Book Trusted Professionals</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {filteredWorkers.map((worker) => (
            <Card key={worker.id} className="border-border hover:shadow-elevated transition-smooth">
              <CardContent className="p-5">
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground font-medium">{worker.category}</p>
                ...
                <div className="flex justify-between items-center mb-4">
                  <div>
                    <p className="text-sm font-bold text-foreground">₹{worker.pricePerHour}<span className="text-xs font-normal text-muted-foreground">/hr</span></p>
                  </div>
                  {worker.isAvailable ? (
